        ...
        if self.request['RequestType']=='StepChain':
            ...
            for spl in splits:
                ...
                if events_per_lumi and 'events_per_job' in task:
                    ...
                    # For the size constraint, need both the filter efficiency of the previous task (efficiency_factor) and of the current task. 
                    ...
                    print("eff at this task {}".format(filter_efficiency_at_this_task))
                    ...
                    while t and 'InputTask' in t:
                        ...
                        if 'FilterEfficiency' in t:
                            ...
                            print("eff_factor = {}".format(efficiency_factor))
                    ...
                    # events_per_lumi_at_this_task is the input events per lumi of the task, after taking filter efficiency of the previous tasks into account
                    print "events_per_lumi_at_this_task: ",events_per_lumi_at_this_task
                    ...
                    if timeperevent:
                        ...
                        if (time_per_input_lumi > (job_timeout*60*60)): ##45h
                            ...
                            # This is the possible events per lumi for this task, after taking filter eff of the input task into account
                            ...
                            #printing events_lumi to test
                            print "max_events_per_lumi in time_per_input_lumi: ", max_events_per_lumi
                        else:
                            pass
                    ...
                    if sizeperevent:# and (avg_events_per_job * sizeperevent ) > (GB_space_limit*1024.**2):
                        ...
                        if (size_per_input_lumi > (GB_space_limit*1024.**2)):
                            ...
                            msg = "The output size of task %s is expected to be too large : %d x %.2f kB = %.2f GB > %f GB. Reducing to %d "% ( tname ,
                                                                                                                                                 avg_events_per_job, sizeperevent, 
                                                                                                                                                 avg_events_per_job * sizeperevent / (1024.**2 ),
                                                                                                                                                 GB_space_limit,
                                                                                                                                                 this_max_events_per_lumi)
                            ...
                            modified_splits.append( modified_split_for_task )
                            print "modified_splits: ",modified_splits
                            max_events_per_lumi.append( this_max_events_per_lumi ) ## adding this to that later on we can check and adpat the split 0
                            print "max_events_per_lumi in sizeperinputlumi: ",max_events_per_lumi
