...
listcommand="condor_status -pool "+collectorCERN+" -schedd | awk '{print $1}'"
...
listcommand="condor_status -pool "+collectorFNAL+" -schedd | awk '{print $1}'"
proc = subprocess.Popen(listcommand, stderr = subprocess.PIPE,stdout = subprocess.PIPE, shell = True)
out, err = proc.communicate()
listscheddsFNAL=[]
for line in out.split('\n') :
...
for schedd in listscheddsCERN+listscheddsFNAL:
	command=""	
